          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              ...
              <div class="pull-right">
                <a href="<?php echo site_url('usr/login/logout/'); ?>" class="btn btn-danger btn-flat"><i class="fa fa-power-off"></i>&nbsp;Log Out</a>
              </div>
            </li>
          </ul>
        </li>
    ...
    <!-- <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
            ...
            ?><br/>
						<small><i class="fa fa-tag"></i>&nbsp;<? php // echo $_SESSION['user_group_name']
                                                  ?>- <i class="fa fa-university"></i>&nbsp;<?php //echo $_SESSION['user_org_name'];
                                                                                            ?></small>						
					</p>
        </div>
      </div> -->
