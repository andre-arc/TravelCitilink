<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form name="f_forgot" id="f_forgot" action="<?php echo site_url('usr/register/add'); ?>" method="POST">
      ...
      <div class="row">
        <div class="col-xs-6">
          <a href="<?php echo site_url('usr/login/'); ?>" class="btn btn-danger btn-flat" tabindex="4">
